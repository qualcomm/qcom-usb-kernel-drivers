GobiNet network driver 2020-07-23
...
This Release (GobiNet network driver)
a. Added support for virtual Network interfaces for MultiPDN calls
b. Added dependency of InfParser driver

Prior Release (GobiNet network driver 2017-02-24)
