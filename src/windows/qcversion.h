...
#define QIK_PACKAGE_VERSION 1.00.94.13 //Install Shield version and QIK package version

#define QCOM_USB_DRIVERS_PRODUCT_VERSION 1.00.94.13
#define QCOM_USB_DRIVERS_FILE_VERSION 1,00,94,13
