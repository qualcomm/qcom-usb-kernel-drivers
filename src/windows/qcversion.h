...
#define QCOM_FILTER_FILE_VERSION_STRING QCSTR(QCOM_FILTER_FILE_VERSION)
#define QCOM_NET_FILE_VERSION 5,0,1,0
#define QCOM_NET_FILE_VERSION_STRING QCSTR(QCOM_NET_FILE_VERSION)
#define QCOM_WDFSERIAL_FILE_VERSION 1,0,3,3
#define QCOM_WDFSERIAL_FILE_VERSION_STRING QCSTR(QCOM_WDFSERIAL_FILE_VERSION)
#define QCOM_QDSS_FILE_VERSION 1,0,4,1
#define QCOM_QDSS_FILE_VERSION_STRING QCSTR(QCOM_QDSS_FILE_VERSION)
