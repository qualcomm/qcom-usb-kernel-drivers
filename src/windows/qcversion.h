...
#define QCOM_USB_DRIVERS_FILE_VERSION 1,00,94,2
...
#define QCOM_USB_DRIVERS_INSTALLER_NAME "Qualcomm USB Kernel Driver Installer"
#define QCOM_USB_DRIVERS_INSTALLER_NAME_W L"Qualcomm USB Kernel Driver Installer"
