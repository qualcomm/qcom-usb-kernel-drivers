...
#define QCOM_USB_DRIVERS_PRODUCT_VERSION 1.00.95.0
#define QCOM_USB_DRIVERS_FILE_VERSION 1,00,95,0
...
#define QCOM_NET_VERSION 5.0.1.3
#define QCOM_NET_FILE_VERSION 5,0,1,3
#define QCOM_NET_FILE_VERSION_STRING QCSTR(QCOM_NET_VERSION)

#define QCOM_WDFSERIAL_VERSION 1.0.3.8
#define QCOM_WDFSERIAL_FILE_VERSION 1,0,3,8
