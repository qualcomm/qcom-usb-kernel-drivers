...
#define QIK_INSTALLER_VERSION 1.0.163.1 //Latest version of QIK tool
#define QIK_PACKAGE_VERSION 1.00.94.12 //Install Shield version and QIK package version

#define QCOM_USB_DRIVERS_PRODUCT_VERSION 1.00.94.12
#define QCOM_USB_DRIVERS_FILE_VERSION 1,00,94,12
...
#define QCOM_QDSS_VERSION 1.0.4.3
#define QCOM_QDSS_FILE_VERSION 1,0,4,3
