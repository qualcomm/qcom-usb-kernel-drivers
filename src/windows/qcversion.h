...
#define QIK_PACKAGE_VERSION 1.00.94.11 //Install Shield version and QIK package version

#define QCOM_USB_DRIVERS_PRODUCT_VERSION 1.00.94.11
#define QCOM_USB_DRIVERS_FILE_VERSION 1,00,94,11
