...
#define QCOM_USB_DRIVERS_PRODUCT_VERSION 1.00.94.4
#define QCOM_USB_DRIVERS_FILE_VERSION 1,00,94,4
...
#define QCOM_WDFSERIAL_VERSION 1.0.3.5
#define QCOM_WDFSERIAL_FILE_VERSION 1,0,3,5
