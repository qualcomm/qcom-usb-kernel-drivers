...
#ifdef QC_DUAL_IP_FC
typedef struct _DUAL_IP_FC
{
    UCHAR  TLV3Type;            // 0x1B
    USHORT TLV3Length;          // 1
    UCHAR  ReportUplinkFlowControl; // 0: do not report; 1: report UL flow control change event
} DUAL_IP_FC, *PDUAL_IP_FC;
#endif // QC_DUAL_IP_FC
...
#define TLV_WDS_UL_FLOW_CONTROL   0x27
typedef struct _QMIWDS_EVENT_REPORT_UL_FC_TLV
{
    UCHAR  Type;    // 0x27
    USHORT Length;  // 1
    UCHAR  UplinkFlowControl;
} QMIWDS_EVENT_REPORT_IND_UL_FC_TLV, *PQMIWDS_EVENT_REPORT_IND_UL_FC_TLV;
