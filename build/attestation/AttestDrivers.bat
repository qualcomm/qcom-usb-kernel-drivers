...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "!ATTEST_SCRIPT!" -ProductName "QUD_!VERSION!_EXT" -Signatures "!SIG_X64_RS4!","!SIG_X64_CO!","!SIG_X64_NI!","!SIG_X64_GE!","!SIG_ARM64_RS4!","!SIG_ARM64_CO!","!SIG_ARM64_NI!","!SIG_ARM64_GE!" -InputPath "!CAB_PATH!"
if !ERRORLEVEL! neq 0 (
